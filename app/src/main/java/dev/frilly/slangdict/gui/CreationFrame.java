...
public final class CreationFrame implements Overrideable {
    ...
    private final JRadioButton bootstrap100k    = new JRadioButton(
        "Bootstrap with 100,000 entries");
    private final JRadioButton bootstrapNothing = new JRadioButton(
        "Don't bootstrap with anything");
    ...
    private void setup() {
        ...
        cancel.setIcon(
            Application.getIcon(getClass().getResource("/icons/close.png"), 16,
                16));
        create.setIcon(Application.getIcon(
            getClass().getResource("/icons/library-add.png"), 16, 16));
    ...
    private void setupActions() {
        field.getDocument()
            .addDocumentListener(
                (DocumentChangeListener) e -> create.setEnabled(
